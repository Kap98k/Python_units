...
class Counter:
    ...
    def __add__(self, string: str):
        ...
        for val in self.values:
            newList.append(self.__concat(val, string))
    ...
    def __concat(self, val: int, string : str):
        template = "{value} {postfix}"
        return template.format(value=str(val), postfix=string)
    

print(Counter([1, 2, 3]) + "арбуз")